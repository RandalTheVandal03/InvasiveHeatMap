...
#     print("Clicked on the transparent image")

# # Create a tkinter window
# window = Tk()

# # Create a canvas to display the image
# canvas = Canvas(window, width=monitor[0].width, height=monitor[0].height)
# canvas.pack()

# # Load the transparent PNG image
# image = PhotoImage(file="Images/US_States.png")

# # Display the image on the canvas
# canvas.create_image(0, 0, anchor="nw", image=image)

# # Bind the click event to the image
# canvas.tag_bind("image", "<Button-1>", handle_click())
